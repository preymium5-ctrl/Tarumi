...
import org.koitharu.kotatsu.stats.data.StatsChapterEntity
...
@Database(
	entities = [
		...
		MangaSourceEntity::class, StatsEntity::class, StatsChapterEntity::class, LocalMangaIndexEntity::class,
