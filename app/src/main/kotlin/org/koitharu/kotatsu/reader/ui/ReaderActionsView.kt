...
class ReaderActionsView @JvmOverloads constructor(
	...
	var isNextEnabled: Boolean
		...
		set(value) {
			...
			binding.buttonNext.alpha = if (value) 1f else 0.28f
		}
	...
	var isPrevEnabled: Boolean
		...
		set(value) {
			...
			binding.buttonPrev.alpha = if (value) 1f else 0.28f
		}
	...
	private fun updateControlsVisibility() {
		...
		binding.buttonPrev.isVisible = true
		binding.buttonNext.isVisible = true
		binding.buttonPagesThumbs.isVisible = true
