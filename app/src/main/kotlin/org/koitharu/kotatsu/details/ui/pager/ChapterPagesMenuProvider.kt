	...
	override fun onCreateMenu(menu: Menu, menuInflater: MenuInflater) {
		...
		when (tab) {
			TAB_CHAPTERS -> {
				...
				menu.findItem(R.id.action_reversed)?.apply {
					isChecked = viewModel.isChaptersReversed.value == true
					setIcon(if (isChecked) R.drawable.ic_arrow_down else R.drawable.ic_arrow_up)
				}
