...
class GridSpanResolver(
	...
	fun setGridSize(scaleFactor: Float, rv: RecyclerView) {
		val baseWidth = if (rv.tag == TARUMI_REMOTE_GRID_TAG) remoteGridWidth else gridWidth
		cellWidth = (baseWidth * scaleFactor) + spacing
	...
	companion object {
		...
		const val TARUMI_REMOTE_GRID_TAG = "tarumi_remote_grid"
	}
}
